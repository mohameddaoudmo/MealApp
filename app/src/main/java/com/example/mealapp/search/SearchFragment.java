...
public class SearchFragment extends Fragment  implements com.example.mealapp.search.SearchView {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        removefromFav =view.findViewById(R.id.removefromfavmealviewhse);
        ...
        presenter = new SearchPresenter(this, Repository.getInstance(ConcreteLocalSource.getInstance(getContext()), ApiClient.getInstance(), getContext()));
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                apiClient.retrievequry(query);
                presenter.getCoonection(); // Call the method
    ...
    @Override
    public void setIgriedent(List<RandomMeal> meal) {
        if(meal!=null){
            ...
            showDialog("There is no meal With this name");
    ...
    @Override
    public void checkunscuss(boolean i) {
if(i){
    showDialog("There is no meal With this name");
